...
class RunBotView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        Если пользователь авторизован, то запускает бота с помощью
        subprocess.Popen и перенаправляет на главную страницу.
        Если пользователь не авторизован, то выводит сообщение об ошибке
